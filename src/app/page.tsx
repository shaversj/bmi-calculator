  ...
  return (
    <div>
      <main>
        <div
          className={
            "rounded-hero relative flex h-[640px] flex-col items-center bg-custom-gradient px-6 md:gap-y-[40px] md:px-0 md:px-[40px] md:pt-8 lg:h-[686px] lg:w-[978px] lg:flex-row lg:gap-x-8 lg:gap-y-0 lg:px-0 lg:pb-[107px] lg:pl-[116px] lg:pt-[182px]"
          }
        >
          <svg className={"mt-[33px] lg:hidden"} width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
          ...
          <div className={"space-y-6 pt-6 md:pt-0 lg:min-w-[564px] lg:space-y-[30px] lg:self-center"}>
            <h1 className={"text-center font-interSemibold text-heading-l text-gunmetal md:text-center lg:w-[520px] lg:text-left lg:text-heading-xl"}>
          ...
          <div className={"absolute translate-y-[29rem] md:mx-[40px] md:translate-y-[20rem] lg:relative lg:mx-0 lg:translate-y-0"}>
            <form className={"shadow-form space-y-8 rounded-2xl bg-white p-8 lg:w-[564px]"}>
              ...
              {selectedUnit === "metric" ? (
                <>
                  <div className={"flex flex-col gap-y-4 md:flex-row md:gap-x-6 md:gap-y-0"}>
        ...
        <div className={"pt-[480px] md:-ml-[75px] md:flex md:items-center md:justify-center md:gap-x-[75px] md:pt-[250px] lg:-ml-0 lg:gap-x-[131px] lg:px-[116px] lg:pt-[65px]"}>
        ...
        <div id={"benefits"} className={"mt-[92px] px-5 md:px-[40px] md:py-[60px] lg:px-[116px] lg:pb-[96px]"}>
        ...
        <div className={"mt-[102px] flex flex-col items-center lg:flex lg:flex-row lg:items-start lg:pl-[116px]"}>
          <div className={"space-y-8 lg:w-[564px] lg:space-y-[35px]"}>
            <h4 className={"text-center font-interSemibold text-heading-l-mobile text-gunmetal md:text-heading-l lg:text-left"}>Limitations of BMI</h4>
