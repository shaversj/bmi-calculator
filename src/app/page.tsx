...
import { bmiSchema, WeightRange } from "@/app/types/types";
import { radioMetadata, inputMetadata, limitations, benefits } from "@/app/data/data";
  ...
  return (
    <div>
      <main className={"lg:pl-6"}>
        <section className={"relative flex h-[640px] flex-col items-center rounded-hero bg-custom-gradient px-6 md:gap-y-[40px] md:px-[40px] lg:h-[686px] lg:w-[978px] lg:flex-row lg:gap-x-8 lg:gap-y-0 lg:px-0 lg:pb-[107px] lg:pl-[116px] lg:pt-[182px]"}>
        ...
        <section className={"pt-[480px] md:-ml-[75px] md:flex md:items-center md:justify-center md:gap-x-[75px] md:pt-[250px] lg:-ml-0 lg:gap-x-[131px] lg:px-[116px] lg:pt-[65px]"}>
          ...
          <div className={"space-y-8 px-6 pt-[48px] md:px-0 md:pt-0 lg:self-end lg:pb-[40px]"}>
            ...
            <p className={"font-interRegular text-body-m text-dark-electric-blue"}>
              A BMI range of 18.5 to 24.9 is considered a 'healthy weight.' Maintaining a healthy weight may lower your chances of experiencing health issues later on, such as obesity and type 2 diabetes. Aim for a nutritious diet with reduced fat and sugar content, incorporating ample fruits and
