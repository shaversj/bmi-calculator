  ...
  return (
    <div>
      <main>
        <div
          className={
            "rounded-hero relative flex flex-col items-center bg-custom-gradient md:h-[640px] md:gap-y-[40px] md:px-[40px] md:pt-8 lg:h-[686px] lg:w-[978px] lg:flex-row lg:gap-x-8 lg:gap-y-0 lg:px-0 lg:pb-[107px] lg:pl-[116px] lg:pt-[182px]"
          }
        >
          <svg className={"lg:hidden"} width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
          ...
          <div className={"space-y-6 lg:min-w-[564px] lg:space-y-[30px] lg:self-center"}>
          ...
          <div className={"absolute md:mx-[40px] md:translate-y-[20rem] lg:relative lg:mx-0 lg:translate-y-0"}>
            <form className={"shadow-form space-y-8 rounded-2xl bg-white p-8 lg:w-[564px]"}>
              ...
              <div className={"flex flex-col gap-y-4 rounded-l-[999px] rounded-r-full bg-blue p-8 text-white"}>
                {isValid ? (
        ...
        <div className={"flex items-center justify-center md:-ml-[75px] md:gap-x-[75px] md:pt-[250px] lg:-ml-0 lg:gap-x-[131px] lg:px-[116px] lg:pt-[65px]"}>
          <Image className={"md:h-[411.09px] md:w-[435px] lg:h-[533px] lg:w-[564px]"} src={"/images/image-man-eating.webp"} alt={"Image of Person Eating"} width={564} height={533} />
          <div className={"space-y-8 lg:self-end lg:pb-[40px]"}>
        ...
        <div id={"benefits"} className={"mt-[92px] md:px-[40px] md:py-[60px] lg:px-[116px] lg:pb-[96px]"}>
          <div className={"flex flex-col gap-y-[40px] lg:flex-row lg:gap-x-8"}>
            {benefits.map((benefit) => (
              <div key={benefit.title} className={"md:flex md:gap-x-[40px] lg:flex-none"}>
                <Image src={benefit.image} alt={benefit.title} width={64} height={64} />
                <div className={"space-y-6 md:w-[582px] lg:w-[365px]"}>
        ...
        <div className={"mt-[102px] lg:flex lg:pl-[116px]"}>
          <div className={"space-y-8 lg:w-[564px] lg:space-y-[35px]"}>
            <h4 className={"text-center font-interSemibold text-heading-l text-gunmetal lg:text-left"}>Limitations of BMI</h4>
            <p className={"text-center font-interRegular text-body-m text-dark-electric-blue lg:text-left"}>
          ...
          <div className={"pt-[56px] lg:absolute lg:ml-[315px]"}>
            <div className={"space-y-4 pb-[96px] md:w-[686px] md:pb-[95.91px] lg:w-[961px] lg:space-y-6 lg:pb-[120px]"}>
              ...
              <div className={"lg:flex lg:justify-end lg:gap-x-8"}>
