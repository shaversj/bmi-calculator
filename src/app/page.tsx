...
export default function Home() {
  ...
  return (
    <div>
      <main>
        <div className={"rounded-hero relative flex h-[686px] flex-col items-center bg-custom-gradient md:gap-y-[40px] md:px-[40px] md:pt-8 lg:w-[978px] lg:flex-row lg:gap-x-8 lg:gap-y-0 lg:px-0 lg:pb-[107px] lg:pl-[116px] lg:pt-[182px]"}>
          ...
          <div className={"absolute md:translate-y-[22rem] lg:relative lg:translate-y-0"}>
        ...
        <div className={"flex gap-x-[131px] px-[116px] lg:pt-[65px]"}>
        ...
        <div id={"benefits"} className={"mt-[92px] pt-[127.61px] md:pt-[96px] lg:px-[116px] lg:pb-[96px]"}>
          <div className={"flex flex-col gap-y-[40px] md:flex-row md:gap-y-0 lg:gap-x-8"}>
