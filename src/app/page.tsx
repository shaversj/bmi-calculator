  ...
  return (
    <div>
      <main className={"lg:pl-6"}>
        <div className={"rounded-hero relative flex h-[640px] flex-col items-center bg-custom-gradient px-6 md:gap-y-[40px] md:px-[40px] lg:h-[686px] lg:w-[978px] lg:flex-row lg:gap-x-8 lg:gap-y-0 lg:px-0 lg:pb-[107px] lg:pl-[116px] lg:pt-[182px]"}>
          <svg className={"mt-8 lg:absolute lg:mt-0 lg:size-16 lg:-translate-y-[285px]"} width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
          ...
          <div className={"absolute mx-[23px] translate-y-[29rem] md:mx-[40px] md:translate-y-[22rem] lg:relative lg:mx-0 lg:translate-y-0"}>
            <form className={"shadow-form space-y-8 rounded-2xl bg-white p-6 md:p-8 lg:w-[564px]"}>
        ...
        <div className={"mx-auto mt-[102px] flex flex-col items-center md:w-[686px] lg:mx-0 lg:flex lg:flex-row lg:items-start lg:pl-[116px]"}>
